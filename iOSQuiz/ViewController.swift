...
class ViewController: UIViewController {
    ...
    @IBAction func answerButtonPressed(sender: UIButton) {
        // if answerLabel is not hidden, display it
        // else set not hidden
        if answerLabel.hidden {
    ...
    @IBAction func nextButtonPressed(sender: UIButton) {
        // if current question is less than count of quizBank - 1 then currentQuestion++
        // else set currentQuestion = 0
